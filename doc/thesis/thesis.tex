...
Pozwoliłoby to na jeszcze dokładniejsze dostosowanie biblioteki do aktualnych potrzeb użytkownika, jak również przyśpieszyłoby jej działanie.
...
%includepdf[scale=0.8,pages=1-25]{refman}

\chapter*{Dodatek A. Oświadczenie}
\addcontentsline{toc}{chapter}{Dodatek A. Oświadczenie}
\newlength{\oldparskip}
...
\addcontentsline{toc}{chapter}{Dodatek B. Opis zawartości płyty CD}
\label{chap:cd}
