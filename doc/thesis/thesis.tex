...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=0.5\textwidth]{small_graph.eps}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=0.65\textwidth]{test_graph_undirected.eps}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=0.65\textwidth]{test_graph_directed.eps}
