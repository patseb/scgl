...
\flushright{\small{Serdeczne podziękowania \\dla Pana dra Ireneusza Szcześniaka \\za poświęcony mi czas oraz nieocenioną pomoc \\w~przygotowaniu niniejszej pracy dyplomowej.}}
\end{minipage}
\end{flushright}
...
\addcontentsline{toc}{chapter}{Dodatek A. SCGL Tutorial}
\markboth{Dodatek A. SCGL Tutorial}{~}
