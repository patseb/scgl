...
\end{itemize}
\begin{table}[htb]
\caption{Wyniki pomiaru rozmiarów plików wynikowych z~zastosowaniem różnych typów konsolidacji}
\label{tab:static}
\centering
...
Jak można zauważyć na powyższej tabeli, rozwiązanie proponowane przez autora pracy, charakteryzuje się najmniejszymi rozmiarami plików. Cecha ta może być ogromną zaletą podczas tworzenia aplikacji na wspomnane systemy wbudowane.
