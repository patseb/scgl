...
int main() {
	...
	//sprawdzić co szybsze, czy stworzenie grafu i add czy stworzenie wszystkiego i stworzenie grafu z v, 1000, e, 1000
	...
	for(i=0; i<m; ++i)
		e[i] = scgl_edge_create(v[i], v[i+1], 1, i, NULL, 0);
